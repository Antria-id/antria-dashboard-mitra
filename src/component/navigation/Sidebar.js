      ...
      <div className="hidden lg:block h-screen">
        <aside
          className={`flex flex-col ${
            expanded ? "w-[17.9rem] h-[51.563rem] ml-[0.5rem]" : "w-[6rem] sm:h-[51.563rem] h-[39.2rem] ml-[2rem]"
        ...
        >
          ...
          <div className={`p-4 ${expanded ? "flex items-center justify-between" : "flex items-center justify-center"}`}>
            <div className={`flex items-center ${expanded ? "" : "justify-center"}`}>
              <img className={`transition-all duration-300 ease-in-out ${expanded ? "" : "w-0"}`} src={Logo} alt="Logo" />
            </div>
          ...
          <div className={`flex items-center ${expanded ? "w-[16rem]" : "w-[4rem]"} h-[3.8rem] ml-[1.125rem] mt-[1rem] bg-gradient-to-r from-[#9b59b6] to-[#e74c3c] rounded-xl transition-all duration-300 ease-in-out`}>
          ...
          <div className="flex-1">
            <ul className={`flex flex-col justify-between mt-12 space-y-6 ${expanded ? "pl-4" : "pl-4"}`}>
                ...
                <li key={index} className="relative group">
                  <Link to={menuItem.to}>
                    <Button
                      ...
                      icon={menuItem.icon}
                      size={`${expanded ? "w-[16rem] h-[2.688rem]" : "w-[4rem] h-[2.688rem]"}`}
                      txtColor={`hover:text-white flex items-center w-[16rem] h-[2.688rem] ${location.pathname === menuItem.to ? "text-white" : ""}`}
                      bgColor={`${location.pathname === menuItem.to ? "bg-gradient-to-r from-[#9b59b6] to-[#e74c3c]" : "hover:bg-gradient-to-r from-[#9b59b6] to-[#e74c3c]"}`}
                      position={`flex ${expanded ? "pl-2 gap-x-[1.2rem] font-extralight" : "justify-center w-[4rem]"}`}
                    />
                  </Link>
                  {!expanded && (
